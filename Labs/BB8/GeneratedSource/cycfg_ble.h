...
#define CY_BLE_GATT_DB_INDEX_COUNT                  (0x0033u)
...
#define CY_BLE_GATT_DB_ATT_VAL_COUNT                (0xBBu)

/** The size of the cy_ble_attValuesLen array */
#define CY_BLE_GATT_DB_ATT_VAL_LEN_COUNT            (0x28u)

/** GATT Role */
#define CY_BLE_GATT_ROLE                            (0x01u)
#define CY_BLE_GATT_DB_CCCD_COUNT                   (0x02u)
#define CY_BLE_ATT_UUID_128_COUNT                   (0x0Bu)
...
#define CY_BLE_CONFIG_CUSTOMS_SERVICE_CHAR_COUNT               (0x0Au)

/** The size of the cy_ble_customSDesc array */
#define CY_BLE_CONFIG_CUSTOMS_SERVICE_CHAR_DESCRIPTORS_COUNT   (0x0Au)
...
#define CY_BLE_LEDS_RED_CHAR_INDEX   (0x00u) /* Index of RED characteristic */
#define CY_BLE_LEDS_RED_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LEDS_GREEN_CHAR_INDEX   (0x01u) /* Index of GREEN characteristic */
#define CY_BLE_LEDS_GREEN_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LEDS_BLUE_CHAR_INDEX   (0x02u) /* Index of BLUE characteristic */
#define CY_BLE_LEDS_BLUE_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LEDS_FORWARD_CHAR_INDEX   (0x03u) /* Index of FORWARD characteristic */
#define CY_BLE_LEDS_FORWARD_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LEDS_REVERSE_CHAR_INDEX   (0x04u) /* Index of REVERSE characteristic */
#define CY_BLE_LEDS_REVERSE_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LEDS_LEFT_CHAR_INDEX   (0x05u) /* Index of LEFT characteristic */
#define CY_BLE_LEDS_LEFT_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LEDS_RIGHT_CHAR_INDEX   (0x06u) /* Index of RIGHT characteristic */
#define CY_BLE_LEDS_RIGHT_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LEDS_MOTOR_ENCODER1_CHAR_INDEX   (0x07u) /* Index of MOTOR_ENCODER1 characteristic */
#define CY_BLE_LEDS_MOTOR_ENCODER1_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LEDS_MOTOR_ENCODER2_CHAR_INDEX   (0x08u) /* Index of MOTOR_ENCODER2 characteristic */
#define CY_BLE_LEDS_MOTOR_ENCODER2_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CY_BLE_LEDS_BUZZER_CHAR_INDEX   (0x09u) /* Index of BUZZER characteristic */
#define CY_BLE_LEDS_BUZZER_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */

#define CY_BLE_LEDS_SERVICE_HANDLE   (0x0015u) /* Handle of LEDS service */
#define CY_BLE_LEDS_RED_DECL_HANDLE   (0x0016u) /* Handle of RED characteristic declaration */
#define CY_BLE_LEDS_RED_CHAR_HANDLE   (0x0017u) /* Handle of RED characteristic */
#define CY_BLE_LEDS_RED_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0018u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LEDS_GREEN_DECL_HANDLE   (0x0019u) /* Handle of GREEN characteristic declaration */
#define CY_BLE_LEDS_GREEN_CHAR_HANDLE   (0x001Au) /* Handle of GREEN characteristic */
#define CY_BLE_LEDS_GREEN_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Bu) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LEDS_BLUE_DECL_HANDLE   (0x001Cu) /* Handle of BLUE characteristic declaration */
#define CY_BLE_LEDS_BLUE_CHAR_HANDLE   (0x001Du) /* Handle of BLUE characteristic */
#define CY_BLE_LEDS_BLUE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x001Eu) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LEDS_FORWARD_DECL_HANDLE   (0x001Fu) /* Handle of FORWARD characteristic declaration */
#define CY_BLE_LEDS_FORWARD_CHAR_HANDLE   (0x0020u) /* Handle of FORWARD characteristic */
#define CY_BLE_LEDS_FORWARD_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0021u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LEDS_REVERSE_DECL_HANDLE   (0x0022u) /* Handle of REVERSE characteristic declaration */
#define CY_BLE_LEDS_REVERSE_CHAR_HANDLE   (0x0023u) /* Handle of REVERSE characteristic */
#define CY_BLE_LEDS_REVERSE_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0024u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LEDS_LEFT_DECL_HANDLE   (0x0025u) /* Handle of LEFT characteristic declaration */
#define CY_BLE_LEDS_LEFT_CHAR_HANDLE   (0x0026u) /* Handle of LEFT characteristic */
#define CY_BLE_LEDS_LEFT_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0027u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LEDS_RIGHT_DECL_HANDLE   (0x0028u) /* Handle of RIGHT characteristic declaration */
#define CY_BLE_LEDS_RIGHT_CHAR_HANDLE   (0x0029u) /* Handle of RIGHT characteristic */
#define CY_BLE_LEDS_RIGHT_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x002Au) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LEDS_MOTOR_ENCODER1_DECL_HANDLE   (0x002Bu) /* Handle of MOTOR_ENCODER1 characteristic declaration */
#define CY_BLE_LEDS_MOTOR_ENCODER1_CHAR_HANDLE   (0x002Cu) /* Handle of MOTOR_ENCODER1 characteristic */
#define CY_BLE_LEDS_MOTOR_ENCODER1_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x002Du) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LEDS_MOTOR_ENCODER2_DECL_HANDLE   (0x002Eu) /* Handle of MOTOR_ENCODER2 characteristic declaration */
#define CY_BLE_LEDS_MOTOR_ENCODER2_CHAR_HANDLE   (0x002Fu) /* Handle of MOTOR_ENCODER2 characteristic */
#define CY_BLE_LEDS_MOTOR_ENCODER2_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0030u) /* Handle of Characteristic User Description descriptor */
#define CY_BLE_LEDS_BUZZER_DECL_HANDLE   (0x0031u) /* Handle of BUZZER characteristic declaration */
#define CY_BLE_LEDS_BUZZER_CHAR_HANDLE   (0x0032u) /* Handle of BUZZER characteristic */
#define CY_BLE_LEDS_BUZZER_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0033u) /* Handle of Characteristic User Description descriptor */
